...
const SCAN = /(^|\/)(\.env|wp-admin|wp-login|wp-json|phpinfo|test\.php|server-status|secrets?\.json|config\.(json|ya?ml)|\.git|vendor\/phpunit)/i;
const ASSET = /\.(?:js|css|png|jpe?g|gif|svg|ico|webp|avif|woff2?|map|xml|txt)(?:$|\?)/i;
