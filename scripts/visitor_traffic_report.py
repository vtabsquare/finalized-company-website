...
PROBE = re.compile(r'(^|/)[.]|(^|/)(?:wp-admin|wp-content|wp-includes|cgi-bin|vendor|phpmyadmin|actuator)(?:/|$)|[.](?:php|asp|aspx|jsp|sql|bak|backup|old|zip|tar|gz|yml|yaml|ini|log|conf|config|key|pem|sh)
